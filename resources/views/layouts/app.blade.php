...
<body>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if(Route::currentRouteName()=='dashboard')
                            ...
                            @endphp
                            @endif
                    <li class="menu-item {{$dashboardAdd}}">
                    ...
                    @if( Route::currentRouteName()=='products'
                        ...
                        || Route::currentRouteName()=='coupon.edit'
                        || Route::currentRouteName()=='coupon.update'
                        || Route::currentRouteName()=='coupons.onlineDiscountsAll'
                        || Route::currentRouteName()=='coupons.deleteDiscountsAll'
                        || Route::currentRouteName()=='coupon.delete'
                    ...
                    @endphp
                    @endif
                    <li class="menu-item {{$productsView}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{$productsShow}}">
                            ...
                            <li class="menu-item {{$productsAdd}}">
                                <a href="{{ url('products/create') }}" class="menu-link">
                                    <div data-i18n="Add Product">Add Product</div>
                                </a>
                            </li>

                            @if( Route::currentRouteName()=='coupons'
                                || Route::currentRouteName()=='coupon.create'   
                                || Route::currentRouteName()=='coupon.store' 
                                || Route::currentRouteName()=='coupon.edit'
                                || Route::currentRouteName()=='coupon.update'
                    ...
                    @if( Route::currentRouteName()=='testimonials'
                        || Route::currentRouteName()=='testimonials.create'   
                        || Route::currentRouteName()=='testimonials.store' 
                        || Route::currentRouteName()=='testimonial.edit'
                        || Route::currentRouteName()=='testimonial.update'
                        || Route::currentRouteName()=='testimonials.onlineDiscountsAll'
                        || Route::currentRouteName()=='testimonials.deleteDiscountsAll'
                        || Route::currentRouteName()=='testimonial.delete'  
                    )
                    @php
                    $testimonialsAdd = 'active';
                    @endphp
                    @else
                    @php
                    $testimonialsAdd = '';
                    ...
                    <li class="menu-item {{$testimonialsAdd}}">
                    ...
                    @if( Route::currentRouteName()=='enquiries'
                        || Route::currentRouteName()=='enquiries.deleteEnquiriesAll'
    ...
    <script>
        document.getElementById('submit_testimonial_btn').addEventListener('click', function(event) {
            var userRating = document.getElementById('user_rating').value;
            if (userRating < 1 || userRating > 5 || isNaN(userRating)) {
                event.preventDefault(); // Prevent form submission
                // alert('Please enter a rating between 1 and 5');
                let html =
                '<div class="toast toast-autohide show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false"><div class="toast-header" style="background: #ff0000;color: #fafbfd;"><strong class="me-auto">Danger!</strong><small class="text-muted" style="color:#ffffff!important">just now</small><button type="button" class="ms-1 btn-close" data-bs-dismiss="toast" aria-label="Close"></button></div><div class="toast-body">Please enter a rating between 1 and 5</div></div>';
                $(".messageShowAlert").append(html);
            }
        });

        // Restrict input to digits only
        document.getElementById('user_rating').addEventListener('keypress', function(event) {
