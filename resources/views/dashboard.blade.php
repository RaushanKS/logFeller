                            ...
                            <div class="col-xl-4 mb-4 col-lg-5 col-12">
                                ...
                                <div class="d-flex align-items-end row">
                                    ...
                                    <div class="card-body text-nowrap">
                                        <h5 class="card-title mb-0">Congratulations {{$loggedInUser}}! 🎉</h5>
                            ...
                            <div class="col-xl-8 mb-4 col-lg-7 col-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-3 col-6">
                                        ...
                                        <div class="card-info">
                                            <h5 class="mb-0">{{$recentProducts}}</h5>
                                        ...
                                        <ul class="p-0 m-0">
                                            ...
                                            <li class="d-flex align-items-center mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <div class="user-progress">
                                                        <p
                                                            class="text-danger fw-medium mb-0 d-flex justify-content-center gap-1">
                                            ...
                                            <li class="d-flex align-items-center mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <div class="user-progress">
                                                        <p
                                                            class="text-success fw-medium mb-0 d-flex align-items-center gap-1">
                                                            <i class='ti ti-chevron-up'></i>
                                                            12.4%
                                                        </p>
                                                    </div>
