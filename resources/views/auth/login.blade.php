...
<head>
    ...
    <title>Login | The Log Feller</title>
  ...
  <div class="authentication-inner row">
    ...
    <div class="toast-container position-fixed top-0 end-0 p-2 messageShowAlert">
      ...
      <div class="w-px-400 mx-auto">
        ...
        <!-- /Logo -->
        <h3 class="mb-1">Welcome to The Log Feller! 👋</h3>
        ...
        <input type="hidden" name="role" value="1" />
          <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="email@example.com" value="{{ old('email') }}"  required="true" autofocus>
          </div>
          <div class="mb-3 form-password-toggle">
            ...
            <div class="input-group input-group-merge">
              <input type="password" id="password" class="form-control" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password"  required="true" />
              <span class="input-group-text cursor-pointer"><i class="ti ti-eye-off"></i></span>
            </div>
          </div>
          <div class="mb-3">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="remember-me" {{ old('remember') ? 'checked' : '' }} name="remember">
